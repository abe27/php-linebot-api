...
class UpdateStock extends Command
{
    ...
    {
        $whs = FormulaWhouse::where('FCCODE', Str::trim($this->argument('whs')))->first();
        ...
        if ($whs) {
            foreach ($prods as $p) {
                ...
                //     'FCPROD' => Str::trim($p->FCSKID),
                //     'FCWHOUSE' => Str::trim($whs->fcskid),
                //     'FCIOTYPE' => "I",
                // ])
                ...
                //     'FCCORP' => 'H2ZFEv02',
                //     'FCBRANCH' => 'H2Z2kf01',
                //     'FCWHOUSE' => Str::trim($whs->FCSKID), //'{str(w['FCSKID']).strip()}',
                //     'FCPROD' => Str::trim($p->FCSKID), //'{str(r[0])}',
